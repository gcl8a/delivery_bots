...
//    DEBUG_SERIAL.print("\n");
//    DEBUG_SERIAL.print(P[0][0]);
//    DEBUG_SERIAL.print(" ");
//    DEBUG_SERIAL.print(P[0][1]);
//    DEBUG_SERIAL.print(" ");
//    DEBUG_SERIAL.print(P[0][2]);
//    DEBUG_SERIAL.print("\n");
//    DEBUG_SERIAL.print(P[1][0]);
//    DEBUG_SERIAL.print(" ");
//    DEBUG_SERIAL.print(P[1][1]);
//    DEBUG_SERIAL.print(" ");
//    DEBUG_SERIAL.print(P[1][2]);
//    DEBUG_SERIAL.print("\n");
//    DEBUG_SERIAL.print(P[2][0]);
//    DEBUG_SERIAL.print(" ");
//    DEBUG_SERIAL.print(P[2][1]);
//    DEBUG_SERIAL.print(" ");
//    DEBUG_SERIAL.print(P[2][2]);
//    DEBUG_SERIAL.print("\n");

    TMatrix<float> K = PHt * denominator;

//    DEBUG_SERIAL.print("\n");
//    DEBUG_SERIAL.print(K[0][0]);
//    DEBUG_SERIAL.print(" ");
//    DEBUG_SERIAL.print(K[0][1]);
//    DEBUG_SERIAL.print("\n");
//    DEBUG_SERIAL.print(K[1][0]);
//    DEBUG_SERIAL.print(" ");
//    DEBUG_SERIAL.print(K[1][1]);
//    DEBUG_SERIAL.print("\n");
//    DEBUG_SERIAL.print(K[2][0]);
//    DEBUG_SERIAL.print(" ");
//    DEBUG_SERIAL.print(K[2][1]);
//    DEBUG_SERIAL.print("\n");
    ...
    TVector<float> innovation = z - H * x;
//    innovation[0] = xGPS - currPose.x;
//    innovation[1] = yGPS - currPose.y;

//    DEBUG_SERIAL.print(innovation[0]);
//    DEBUG_SERIAL.print(",");
//    DEBUG_SERIAL.print(innovation[1]);
//    DEBUG_SERIAL.print(" ");

    //delta x
    TVector<float> xDelta = K * innovation;

//    DEBUG_SERIAL.print(xDelta[0]);
//    DEBUG_SERIAL.print(",");
//    DEBUG_SERIAL.print(xDelta[1]);
//    DEBUG_SERIAL.print(" ");
    ...
    DEBUG_SERIAL.print(xGPS);
    DEBUG_SERIAL.print('\t');
    DEBUG_SERIAL.print(yGPS);
    DEBUG_SERIAL.print('\t');
